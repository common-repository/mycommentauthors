...
///Generate script
				...
				$tableHead="<div align=\"center\"><h3>Total Comments on this blog in $month $date2</h3></div>
				<table width=\"80%\" align=\"center\" border=\"0\" cellspacing=\"2\" cellpadding=\"2\">";	
				$tbData="";
				$countAuthors=0;
				$countComments=0;
				$pageBreakCounter=0;
				...
				if($PageBreak > 0 )
						...
						if($pageBreakCounter == $PageBreak)
							{
								...
								$tbData.="</table><br><center><b>Click The Page Number Below To Continue</b><br>
								<!--nextpage--></center><br><div align=\"center\"><h3>Total Comments on this blog in $month $date2</h3> <br>List Continues</b></div>
								<table width=\"80%\" align=\"center\" border=\"0\" cellspacing=\"2\" cellpadding=\"2\">";
								$pageBreakCounter=0;
							}
					}
						$tbData.="<tr><td valign=\"top\" width=\"10%\" style=\"border-bottom: #CCCCCC dotted thin;\">
					...
					$html.=$tbData;
					$html.="
						<tr><td colspan=\"2\"><b>$countAuthors</b> comment authors with <b>$countComments</b> comments in the month of <b>$month $date2</b>
						<br><i>This list was generated by <a href=\"http://enstinemuki.com/my-comment-authors\" target=\"_blank\">MyCommentAuthors</a></i></td></tr>		                        </table>";
